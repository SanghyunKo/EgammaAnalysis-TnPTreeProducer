...
registerOption('hasJet',      True,     'Tag & match HLT jet (e.g. for Ele+Jet triggers)')
...
registerOption('era',         'UL2016postVFP',   'Data-taking era: 2016, 2017, 2018, UL2017 or UL2018', optionType=VarParsing.varType.string)
...
options['hasJet']               = varOptions.hasJet
...
if varOptions.GT == "auto":
  if options['isMC']:
    ...
    if options['era'] == 'UL2016preVFP':  options['GLOBALTAG'] = '106X_mcRun2_asymptotic_preVFP_v11'
    if options['era'] == 'UL2016postVFP': options['GLOBALTAG'] = '106X_mcRun2_asymptotic_v17'
    if options['era'] == 'UL2017': options['GLOBALTAG'] = '106X_mc2017_realistic_v9'
    ...
    if options['era'] == 'UL2016preVFP':  options['GLOBALTAG'] = '106X_dataRun2_v35'
    if options['era'] == 'UL2016postVFP': options['GLOBALTAG'] = '106X_dataRun2_v35'
    if options['era'] == 'UL2017': options['GLOBALTAG'] = '106X_dataRun2_v35'
    if options['era'] == 'UL2018': options['GLOBALTAG'] = '106X_dataRun2_v36'
else:
...
if '2016' in options['era']:
  options['TnPPATHS']           = cms.vstring("HLT_Ele115_CaloIdVT_GsfTrkIdT_v*","HLT_Ele50_CaloIdVT_GsfTrkIdT_PFJet165_v*","HLT_Photon175_v*")
  options['TnPHLTTagFilters']   = cms.vstring("hltEle115CaloIdVTGsfTrkIdTGsfDphiFilter","hltEle50CaloIdVTGsfTrkIdTCentralPFJet165EleCleaned","hltEG175HEFilter")
  options['TnPHLTProbeFilters'] = cms.vstring()
  options['HLTFILTERSTOMEASURE']= {"passHltEle115CaloIdVTGsfTrkIdT" : cms.vstring("hltEle115CaloIdVTGsfTrkIdTGsfDphiFilter"),
                                   "passHltEle50CaloIdVTGsfTrkIdTPFJet165" : cms.vstring("hltEle50CaloIdVTGsfTrkIdTCentralPFJet165EleCleaned"),
                                   "passHltPhoton175" : cms.vstring("hltEG175HEFilter")}

elif '2017' in options['era']:
  options['TnPPATHS']           = cms.vstring("HLT_Ele115_CaloIdVT_GsfTrkIdT_v*","HLT_Ele50_CaloIdVT_GsfTrkIdT_PFJet165_v*","HLT_Photon200_v*")
  options['TnPHLTTagFilters']   = cms.vstring("hltEle115CaloIdVTGsfTrkIdTGsfDphiFilter","hltEle50CaloIdVTGsfTrkIdTCentralPFJet165EleCleaned","hltEG200HEFilter")
  options['TnPHLTProbeFilters'] = cms.vstring()
  options['HLTFILTERSTOMEASURE']= {"passHltEle115CaloIdVTGsfTrkIdT" : cms.vstring("hltEle115CaloIdVTGsfTrkIdTGsfDphiFilter"),
                                   "passHltEle50CaloIdVTGsfTrkIdTPFJet165" : cms.vstring("hltEle50CaloIdVTGsfTrkIdTCentralPFJet165EleCleaned"),
...
for flag in options['HLTFILTERSTOMEASURE']:
  setattr(process.tnpEleIDs.tagFlags, flag, cms.InputTag("tag"+flag))
...
process.evtCounter.isMC = cms.bool(options['isMC'])

process.tightJetId = cms.EDProducer("PatJetIDValueMapProducer",
                                    filterParams=cms.PSet(
                                        version = cms.string('RUN2UL16'),
